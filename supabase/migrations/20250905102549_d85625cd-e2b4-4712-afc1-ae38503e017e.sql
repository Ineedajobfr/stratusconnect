-- Create admin accounts for owner emails
-- First, let's ensure we have the necessary functions and setup

-- Create admin users with specified credentials
-- Note: These will be created as profiles that can be matched with auth users

-- Insert admin profiles for the owner emails
...
-- Grant admin users access to all psychological tests
-- They should be able to take tests and view all results

-- Update RLS policies to allow admin access to psych system
-- This ensures admins can access psychological testing functionality
