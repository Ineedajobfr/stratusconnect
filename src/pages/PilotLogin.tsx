        ...
        <div className="w-full max-w-md">
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-white">Pilot Terminal</CardTitle>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <div className="text-center p-4 rounded-lg bg-black/50 border border-white/20">
              ...
              <div className="text-sm text-white font-medium">Verified Credentials</div>
              <div className="text-xs text-white/60">Trust & verification</div>
            </div>
            <div className="text-center p-4 rounded-lg bg-black/50 border border-white/20">
              <Clock className="w-6 h-6 text-orange-500 mx-auto mb-2" />
              <div className="text-sm text-white font-medium">Flight Schedule</div>
              <div className="text-xs text-white/60">Manage availability</div>
            </div>
          </div>
        </div>
      </div>
