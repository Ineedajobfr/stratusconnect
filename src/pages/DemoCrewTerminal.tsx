        ...
        <CardContent>
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-green-800">Zero Platform Fees for Crew</p>
            ...
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gunmetal">{job.route} • {job.aircraft} • {job.role}</p>
                </div>
    ...
    <div className="min-h-screen bg-terminal-bg">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Crew Terminal</h1>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-700 text-sm mt-1">
                    This terminal demonstrates the crew experience with zero platform fees. 
