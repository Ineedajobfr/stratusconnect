-- ULTIMATE WORKING ADMIN SETUP - FIXES ALL COLUMN ISSUES
-- This handles the COALESCE username issue properly
...
-- ============================================================================
-- STEP 4: Add to platform_admins table
-- ============================================================================
...
-- ============================================================================
-- STEP 5: Create/Update user in public.users with admin role (FIXED USERNAME ISSUE)
-- ============================================================================

-- First, try to insert without username conflict
