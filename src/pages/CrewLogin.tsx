        ...
        <div className="w-full max-w-md">
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-white">Crew Terminal</CardTitle>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <div className="text-center p-4 rounded-lg bg-black/50 border border-white/20">
              ...
              <div className="text-sm text-white font-medium">Professional Profile</div>
              <div className="text-xs text-white/60">Showcase skills</div>
            </div>
            <div className="text-center p-4 rounded-lg bg-black/50 border border-white/20">
              <Users className="w-6 h-6 text-orange-500 mx-auto mb-2" />
              <div className="text-sm text-white font-medium">Job Matching</div>
              <div className="text-xs text-white/60">Find opportunities</div>
            </div>
          </div>
        </div>
      </div>
