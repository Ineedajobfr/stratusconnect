-- FINAL WORKING ADMIN SETUP - WORKS WITH EXISTING SCHEMA
-- This uses only columns that exist in your users table
...
-- ============================================================================
-- STEP 5: Create/Update user in public.users with admin role (USING EXISTING COLUMNS)
-- ============================================================================
