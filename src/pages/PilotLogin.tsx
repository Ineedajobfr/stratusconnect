        ...
        <div className="w-full max-w-md">
          ...
          <Card className="terminal-card border-terminal-border">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-foreground">Pilot Terminal</CardTitle>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <div className="text-center p-4 rounded-lg bg-terminal-card/30 border border-terminal-border/50">
              ...
              <div className="text-sm text-foreground font-medium">Verified Credentials</div>
              <div className="text-xs text-gunmetal">Trust & verification</div>
            </div>
            <div className="text-center p-4 rounded-lg bg-terminal-card/30 border border-terminal-border/50">
              <Clock className="w-6 h-6 text-accent mx-auto mb-2" />
              <div className="text-sm text-foreground font-medium">Flight Schedule</div>
              <div className="text-xs text-gunmetal">Manage availability</div>
            </div>
          </div>
        </div>
      </div>
