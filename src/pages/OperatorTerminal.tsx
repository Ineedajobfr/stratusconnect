...
import { Plane, Calendar, DollarSign, TrendingUp, Users, MapPin, Clock, Settings, MessageSquare, BarChart3, CheckCircle, Activity, Gauge, Shield, Globe, Brain } from "lucide-react";
        ...
        <div className="space-y-6">
          <Card className="terminal-card">
            <CardHeader>
              ...
              <p className="text-gunmetal">Complete your psychometric evaluation to enhance your operator profile and improve matching with brokers and clients</p>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-gunmetal mb-6 max-w-md mx-auto">
                  Take our aviation-specific personality assessment to understand your operational style, communication preferences, and how you work with brokers and clients.
                </p>
                <Button 
