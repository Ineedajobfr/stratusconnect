...
export default function PilotDashboard() {
  ...
  const [profile] = useState<PilotProfile>({
    name: 'Capt. Sarah Johnson',
    license: 'ATPL',
    typeRatings: ['Gulfstream G650', 'Bombardier Global 6000', 'Citation X'],
    totalHours: 3500,
    baseLocation: 'New York (JFK)',
    languages: ['English', 'French', 'Spanish'],
    experience: '8 years commercial aviation, 5 years private charter',
    certifications: ['ATP', 'Type Ratings', 'First Aid', 'CRM'],
  ...
  const [jobOpportunities] = useState<JobOpportunity[]>([
    {
      ...
      pay: 2500,
      status: 'open',
      requirements: ['G650 Type Rating', 'ATP License', '5+ years experience'],
      description: 'Charter flight for VIP client. Luxury service required.'
    },
    {
      id: 'J-002',
      ...
      pay: 1800,
      status: 'applied',
      requirements: ['Citation X Type Rating', 'ATP License'],
      description: 'Business charter with return flight same day.'
    }
  ]);
  ...
  const [assignments] = useState<Assignment[]>([
    {
      ...
      status: 'upcoming',
      pay: 2200,
      notes: 'International flight, customs clearance required'
    }
  ]);
  ...
  const [notifications] = useState<Notification[]>([
    ...
    },
    {
      ...
      message: '5 operators viewed your profile this week',
      timestamp: '1 day ago',
      read: true
    }
  ]);
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-slate-400">{profile.license} • {profile.totalHours.toLocaleString()} hours</div>
                ...
                <Card className="bg-slate-800 border-slate-700">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-white font-bold">{profile.totalHours.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-slate-400">Type Ratings</span>
                      <span className="text-white font-bold">{profile.typeRatings.length}</span>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <div className="text-slate-400">{assignment.date}</div>
