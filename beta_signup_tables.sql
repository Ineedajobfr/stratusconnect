-- Beta Signup Tables for StratusConnect
...
CREATE TABLE IF NOT EXISTS public.beta_signup_documents (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_beta_signups_priority_score ON public.beta_signups(priority_score DESC);
CREATE INDEX IF NOT EXISTS idx_beta_signups_created_at ON public.beta_signups(created_at);
CREATE INDEX IF NOT EXISTS idx_beta_signups_company_name ON public.beta_signups(company_name);
