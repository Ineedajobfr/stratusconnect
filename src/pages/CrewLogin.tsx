        ...
        <div className="w-full max-w-md">
          ...
          <Card className="terminal-card border-terminal-border">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl font-bold text-foreground">Crew Terminal</CardTitle>
              <CardDescription className="text-gunmetal">
                Professional service wins repeat work. Your calendar is your shop window.
              </CardDescription>
            </CardHeader>
          ...
          <div className="mt-8 grid grid-cols-2 gap-4">
            <div className="text-center p-4 rounded-lg bg-terminal-card/30 border border-terminal-border/50">
              ...
              <div className="text-sm text-foreground font-medium">Professional Profile</div>
              <div className="text-xs text-gunmetal">Showcase skills</div>
            </div>
            <div className="text-center p-4 rounded-lg bg-terminal-card/30 border border-terminal-border/50">
              <Users className="w-6 h-6 text-accent mx-auto mb-2" />
              <div className="text-sm text-foreground font-medium">Job Matching</div>
              <div className="text-xs text-gunmetal">Find opportunities</div>
            </div>
          </div>
        </div>
      </div>
