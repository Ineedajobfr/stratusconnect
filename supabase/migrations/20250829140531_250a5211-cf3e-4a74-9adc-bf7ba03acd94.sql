...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_marketplace_listings_status ON marketplace_listings(status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_marketplace_listings_departure_date ON marketplace_listings(departure_date);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_crew_profiles_availability ON crew_profiles(availability_status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_crew_profiles_user_id ON crew_profiles(user_id);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deals_status ON deals(status);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deals_operator_id ON deals(operator_id);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_deals_broker_id ON deals(broker_id);

-- Optimize messages table for better performance
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_messages_deal_id ON messages(deal_id);
