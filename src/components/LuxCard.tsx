    ...
    <div className="group relative overflow-hidden rounded-xl border border-line bg-glass shadow-insetSoft transition-transform duration-200 ease-out hover:-translate-y-0.5">
      ...
      <div className="p-6">
        ...
        <div className="mt-5 flex items-center gap-4">
          <a href={href} className="inline-flex items-center gap-2 rounded-lg border border-line bg-white/5 px-4 py-2 text-sm transition-colors duration-200 hover:bg-white/10">
